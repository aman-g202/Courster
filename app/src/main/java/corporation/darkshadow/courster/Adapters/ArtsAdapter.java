...
public class ArtsAdapter extends RecyclerView.Adapter<ArtsAdapter.MyViewHolder> implements Filterable {
    ...
    public ArtsAdapter(FragmentActivity context, List<Result> courseList){
