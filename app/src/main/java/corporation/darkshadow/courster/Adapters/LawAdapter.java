...
public class LawAdapter extends RecyclerView.Adapter<LawAdapter.MyViewHolder> implements Filterable {
    ...
    public LawAdapter(FragmentActivity context, List<Result> courseList){
    ...
    @Override
    public LawAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemview = LayoutInflater.from(parent.getContext()).inflate(R.layout.mechanical_list,parent,false);
        return new MyViewHolder(itemview);
    }

    @Override
    public void onBindViewHolder(LawAdapter.MyViewHolder holder, int position) {
