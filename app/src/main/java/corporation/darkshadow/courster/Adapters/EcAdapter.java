...
public class EcAdapter extends RecyclerView.Adapter<EcAdapter.MyViewHolder> implements Filterable {

    private List<Result> courseList;
    private List<Result> courseListFiltered;
    private Context context;

    public EcAdapter(EcActivity context, List<Result> courseList){
    ...
    @Override
    public EcAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemview = LayoutInflater.from(parent.getContext()).inflate(R.layout.mechanical_list,parent,false);
        return new MyViewHolder(itemview);
    }

    @Override
    public void onBindViewHolder(EcAdapter.MyViewHolder holder, int position) {
