...
public class CivilAdapter extends RecyclerView.Adapter<CivilAdapter.MyViewHolder> implements Filterable {

    private List<Result> courseList;
    private List<Result> courseListFiltered;
    private Context context;

    public CivilAdapter(CivilActivity context, List<Result> courseList){
    ...
    @Override
    public CivilAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemview = LayoutInflater.from(parent.getContext()).inflate(R.layout.mechanical_list,parent,false);
        return new MyViewHolder(itemview);
    }

    @Override
    public void onBindViewHolder(CivilAdapter.MyViewHolder holder, int position) {
