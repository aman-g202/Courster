...
public class ItAdapter extends RecyclerView.Adapter<ItAdapter.MyViewHolder> implements Filterable {

    private List<Result> courseList;
    private List<Result> courseListFiltered;
    private Context context;

    public ItAdapter(ItActivity context, List<Result> courseList){
    ...
    @Override
    public ItAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemview = LayoutInflater.from(parent.getContext()).inflate(R.layout.mechanical_list,parent,false);
        return new MyViewHolder(itemview);
    }

    @Override
    public void onBindViewHolder(ItAdapter.MyViewHolder holder, int position) {
