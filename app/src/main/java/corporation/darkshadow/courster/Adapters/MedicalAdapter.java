...
public class MedicalAdapter extends RecyclerView.Adapter<MedicalAdapter.MyViewHolder> implements Filterable {
    ...
    public MedicalAdapter(FragmentActivity context, List<Result> courseList){
    ...
    @Override
    public MedicalAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemview = LayoutInflater.from(parent.getContext()).inflate(R.layout.mechanical_list,parent,false);
        return new MyViewHolder(itemview);
    }

    @Override
    public void onBindViewHolder(MedicalAdapter.MyViewHolder holder, int position) {
