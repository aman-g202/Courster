...
import corporation.darkshadow.courster.Adapters.ArtsAdapter;
...
//        recyclerView.setAdapter(CsAdapter);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerArtsTouchListener(getActivity(), recyclerView, new AddPostFragment.ClickListener() {
            @Override
...
//        whiteNotificationBar(recyclerView);
        ...
        Retrofit check = new Retrofit.Builder()
                ...
                .build();
        Arts service = check.create(Arts.class);
...
//                    Toast.makeText(CsActivity.this,"yeeeeee",Toast.LENGTH_LONG).show();
                    ...
                    artsAdapter = new ArtsAdapter(getActivity(),courseList);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                ArtsAdapter artsAdapter = new ArtsAdapter();
                artsAdapter.getFilter().filter(query);
                return false;
            }
