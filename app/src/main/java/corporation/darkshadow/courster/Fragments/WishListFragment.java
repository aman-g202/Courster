...
import corporation.darkshadow.courster.Adapters.MedicalAdapter;
...
//        recyclerView.setAdapter(CsAdapter);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerMedicalTouchListener(getActivity(), recyclerView, new WishListFragment.ClickListener() {
            @Override
...
//        whiteNotificationBar(recyclerView);
        ...
        Retrofit check = new Retrofit.Builder()
                ...
                .build();
        Medical service = check.create(Medical.class);
...
//                    Toast.makeText(CsActivity.this,"yeeeeee",Toast.LENGTH_LONG).show();
                    ...
                    MedicalAdapter = new MedicalAdapter(getActivity(),courseList);
