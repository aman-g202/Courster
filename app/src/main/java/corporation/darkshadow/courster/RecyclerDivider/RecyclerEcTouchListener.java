...
public class RecyclerEcTouchListener implements RecyclerView.OnItemTouchListener {

    private GestureDetector gestureDetector;
    private EcActivity.ClickListener clickListener;

    public RecyclerEcTouchListener(Context applicationContext, final RecyclerView recyclerView, final EcActivity.ClickListener clickListener) {
