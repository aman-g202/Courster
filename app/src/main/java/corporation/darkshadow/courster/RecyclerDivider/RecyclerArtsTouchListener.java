...
public class RecyclerArtsTouchListener implements RecyclerView.OnItemTouchListener {

    private GestureDetector gestureDetector;
    private AddPostFragment.ClickListener clickListener;

    public RecyclerArtsTouchListener(Context applicationContext, final RecyclerView recyclerView, final AddPostFragment.ClickListener clickListener) {
