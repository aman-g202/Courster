...
public class RecyclerItTouchListener implements RecyclerView.OnItemTouchListener {

    private GestureDetector gestureDetector;
    private ItActivity.ClickListener clickListener;

    public RecyclerItTouchListener(Context applicationContext, final RecyclerView recyclerView, final ItActivity.ClickListener clickListener) {
