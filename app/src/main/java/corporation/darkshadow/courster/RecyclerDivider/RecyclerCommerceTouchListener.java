...
public class RecyclerCommerceTouchListener implements RecyclerView.OnItemTouchListener {

    private GestureDetector gestureDetector;
    private GetInTouchFragment.ClickListener clickListener;

    public RecyclerCommerceTouchListener(Context applicationContext, final RecyclerView recyclerView, final GetInTouchFragment.ClickListener clickListener) {
