...
public class RecyclerNearByTouchListener implements RecyclerView.OnItemTouchListener {

    private GestureDetector gestureDetector;
    private SurprisesFragment.ClickListener clickListener;

    public RecyclerNearByTouchListener(Context applicationContext, final RecyclerView recyclerView, final SurprisesFragment.ClickListener clickListener) {
