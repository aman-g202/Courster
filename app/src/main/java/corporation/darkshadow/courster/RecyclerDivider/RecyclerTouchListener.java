...
public class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    private MechanicalActivity.ClickListener clickListener;

    public RecyclerTouchListener(Context applicationContext, final RecyclerView recyclerView, final MechanicalActivity.ClickListener clickListener) {
