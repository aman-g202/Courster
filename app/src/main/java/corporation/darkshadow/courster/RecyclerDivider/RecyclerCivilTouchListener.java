...
public class RecyclerCivilTouchListener implements RecyclerView.OnItemTouchListener {

    private GestureDetector gestureDetector;
    private CivilActivity.ClickListener clickListener;

    public RecyclerCivilTouchListener(Context applicationContext, final RecyclerView recyclerView, final CivilActivity.ClickListener clickListener) {
