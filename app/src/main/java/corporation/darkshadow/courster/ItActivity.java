...
import corporation.darkshadow.courster.Adapters.ItAdapter;
import corporation.darkshadow.courster.Network.Cs;
import corporation.darkshadow.courster.Network.It;
...
import corporation.darkshadow.courster.RecyclerDivider.RecyclerItTouchListener;
...
//        recyclerView.setAdapter(ItAdapter);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItTouchListener(getApplicationContext(), recyclerView, new ItActivity.ClickListener() {
            @Override
            public void onClick(View view, int position) {
                Result r = courseList.get(position);
//                Toast.makeText(getApplicationContext(), r.getCoursename(), Toast.LENGTH_LONG).show();
                Intent intent = new Intent(ItActivity.this,IndividualCourseActivity.class);
...
//        whiteNotificationBar(recyclerView);
        ...
        Retrofit check = new Retrofit.Builder()
                ...
                .build();
        It service = check.create(It.class);
        Call<Course> userCall = service.getCourses();
        userCall.enqueue(new Callback<Course>() {
            @Override
            public void onResponse(Call<Course> call, Response<Course> response) {
                if(response.isSuccessful()){
//                    Toast.makeText(ItActivity.this,"yeeeeee",Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(ItActivity.this,"Oops! Some issues on the server side",Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                ItAdapter.getFilter().filter(query);
                return false;
            }
