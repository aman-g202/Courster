...
import corporation.darkshadow.courster.Adapters.EcAdapter;
...
//        recyclerView.setAdapter(EcAdapter);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerEcTouchListener(getApplicationContext(), recyclerView, new EcActivity.ClickListener() {
            @Override
            public void onClick(View view, int position) {
                Result r = courseList.get(position);
//                Toast.makeText(getApplicationContext(), r.getCoursename(), Toast.LENGTH_LONG).show();
                Intent intent = new Intent(EcActivity.this,IndividualCourseActivity.class);
...
//        whiteNotificationBar(recyclerView);
        ...
        Retrofit check = new Retrofit.Builder()
                ...
                .build();
        Ec service = check.create(Ec.class);
        Call<Course> userCall = service.getCourses();
        userCall.enqueue(new Callback<Course>() {
            @Override
            public void onResponse(Call<Course> call, Response<Course> response) {
                if(response.isSuccessful()){
//                    Toast.makeText(EcActivity.this,"yeeeeee",Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(EcActivity.this,"Oops! Some issues on the server side",Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                EcAdapter.getFilter().filter(query);
                return false;
            }
